...
const GameCard = ({
  ...
  return (
    <div className="group bg-card rounded-lg overflow-hidden tactical-lift night-vision-hover cursor-tactical">
      {/* Image */}
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="pt-2">
          {status === 'upcoming' ? (
            <Button 
              size="sm"
              className="btn-tactical-primary w-full font-rajdhani font-bold cursor-tactical"
            >
              ЗАПИСАТЬСЯ
            </Button>
          ) : status === 'full' ? (
            <Button 
              size="sm"
              variant="outline"
              className="w-full font-rajdhani font-bold cursor-tactical border-destructive text-destructive hover:bg-destructive hover:text-destructive-foreground"
              disabled
            >
              СПИСОК ОЖИДАНИЯ
            </Button>
            ...
            <Button 
              size="sm"
              variant="outline"
              className="w-full font-rajdhani font-bold cursor-tactical"
            >
              СМОТРЕТЬ ОТЧЕТ
            </Button>
          )}
